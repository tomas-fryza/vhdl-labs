...
##Pmod Header JC
# set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { UART_RXD_OUT }]; #IO_L23N_T3_35 Sch=jc[1]
# set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { LED16_B }]; #IO_L19N_T3_VREF_35 Sch=jc[2]
